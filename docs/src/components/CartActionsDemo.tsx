...
export function CartActionsDemo() {
  const { addToCartAction, addItemState, isAddingItem, isPending } =
    useCartActions()
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="font-semibold mb-2">Try Form-Based Actions:</h4>
            ...
            <form action={addToCartAction} className="flex flex-col gap-2">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="px-4 py-2 bg-fd-primary text-fd-primary-foreground rounded-md hover:bg-fd-primary/90 transition-colors disabled:cursor-not-allowed"
              >
                Add to cart
              </button>
            </form>

            {/* Add with Quantity Form */}
            <form action={addToCartAction} className="flex flex-col gap-2">
              <input
                type="hidden"
                name="product"
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  ...
                  min="1"
                  defaultValue="5"
                  className="w-20 px-2 py-1 border border-fd-border rounded-md bg-fd-background"
                />
              </div>
              <button
                type="submit"
            ...
            <div className="mt-4 p-4 bg-fd-secondary/50 rounded-md text-sm">
              ...
              <ul className="list-disc list-inside space-y-1 text-fd-muted-foreground">
                <li>Uses HTML forms (progressive enhancement)</li>
                <li>Automatic loading states with useActionState</li>
                <li>Built-in error handling and success feedback</li>
