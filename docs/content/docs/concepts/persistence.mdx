...
- [shouldPersist](/docs/usage/configuration/should-persist) - Enable/disable persistence
- [persistKey](/docs/usage/configuration/persist-key) - Custom storage key
- [loadCart](/docs/usage/actions/load-cart) - Load cart manually
