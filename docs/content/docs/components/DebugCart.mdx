...
When using this component, you still must have `<CartProvider>` wrapped around your application. See [the documentation for CartProvider](/docs/components/CartProvider) if you don't know how to do that.
