...
## CheckoutSession Mode (Recommended)

Creating a [CheckoutSession](https://stripe.com/docs/payments/checkout/one-time#create-checkout-session) server-side allows for a more flexible and powerful integration and provides access to all modern Stripe features.
