...
**See:** [Getting Started with Checkout Sessions](/docs/getting-started-serverless) for detailed migration guide.
...
**See:** [Getting Started (Client Mode)](/docs/welcome/getting-started-client-mode#migration-from-client-only)
...
- 💬 [Discord Community](https://discord.gg/TNQfW4W)
