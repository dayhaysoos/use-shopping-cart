...
import { OptimisticCartDemo } from '../../../src/components/OptimisticCartDemo'
...
- [useShoppingCart()](/docs/hooks/useShoppingCart) - Standard cart hook without optimistic updates
