...
```bash
npm install --save stripe use-stripe-cart

or

yarn add stripe use-stripe-cart
```
...
Once you have successfully installed `stripe` and `use-stripe-cart` and wrap your root component with CartProvider, you are ready to go! 🚀
